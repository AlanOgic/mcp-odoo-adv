#!/usr/bin/env python3
"""
Run the Odoo MCP server with SSE (Server-Sent Events) transport.
...
Usage:
    ...
    # Docker
    docker run -p 8000:8000 alanogic/mcp-odoo-adv:sse
"""
...
print(f"[{datetime.now().isoformat()}] Starting Odoo MCP Server (SSE Transport)")
